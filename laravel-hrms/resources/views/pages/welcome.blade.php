...
<div class="container-fluid my-0 py-0">
    <div class="row hero">
        <div class="col-8 offset-1 d-flex align-items-center">
            <div>
                <h1 class="text-white font-weight-bold text-capitalize">Human Resource Management (HRM)</h1>
                <h4 class="text-white">Involves recruiting, training, and managing employees, ensuring compliance with labor laws, and fostering a positive workplace culture..</h4>
            </div>
        </div>
    </div>
</div>
