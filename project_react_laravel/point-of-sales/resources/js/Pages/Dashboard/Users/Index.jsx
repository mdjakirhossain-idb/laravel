                    ...
                    <div className='flex flex-row gap-2 items-center'>
                        ...
                        {data.selectedUser.length > 0 &&
                            <Button
                                ...
                                label={`Delete ${data.selectedUser.length} selected data`}
                                added={true}
                        ...
                        {users.data.length ?
                            ...
                            <Table.Empty colSpan={6} message={
                                <>
                                    ...
                                    <span className='text-gray-500'>User data</span> <span className='text-rose-500 underline underline-offset-2'>Not found.</span>
                                </>
                            } />
                        }
                    </Table.Tbody>
