...
export default function Index({ carts, carts_total, customers }) {
    ...
    const formatPrice = (price) => {
        return price.toLocaleString('en-BD', { style: 'currency', currency: 'BDT' });
    };
    ...
    const storeTransaction = (e) => {
        e.preventDefault();
        if (!data.customer_id) {
            toast('Please select a customer first', {
                style: {
                    borderRadius: '10px',
                    background: '#FF0000',
                    color: '#fff',
            ...
            if (cash >= grandTotal) {
                router.post(route('transactions.store'), {
                    ...
                    onSuccess: () => {
                        toast('Transaction data saved successfully', {
                            icon: '👏',
                            style: {
                                borderRadius: '10px',
                                background: '#1C1F29',
        ...
        <>
            ...
            <div className="grid grid-cols-12 gap-4">
                <div className="col-span-12 md:col-span-4">
                    ...
                    >
                        <div className="mb-2">
                            <Input
                                type={'text'}
                                label={'Scan/Input Product Barcodev'}
                ...
                <div className="col-span-12 md:col-span-8">
                        ...
                        <div className="grid grid-cols-12 gap-4">
                            <div className="col-span-12">
                                <div className="flex justify-between">
                                    <h1 className="text-lg md:text-2xl text-black dark:text-white">Total Bill</h1>
                    ...
                    <Table.Card title={'Cart'} className={'mt-5'}>
                        <Table>
                            <Table.Thead>
                                <tr>
