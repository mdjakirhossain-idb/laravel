                ...
                <div className='flex justify-between items-center gap-2'>
                    ...
                    <div className='w-full md:w-4/12'>
                        <Search
                            ...
                            placeholder='Search for data based on customer name...'
                        />
                    </div>
                </div>
            </div>
                ...
                <Table>
                    <Table.Thead>
                        <tr>
                            ...
                            <Table.Th className='w-40'>phone No </Table.Th>
                        ...
                        {customers.data.length ?
                            ...
                            <Table.Empty colSpan={5} message={
                                <>
                                    ...
                                    <span className='text-gray-500'>Customer data</span> <span className='text-rose-500 underline underline-offset-2'>Not found</span>
                                </>
                            } />
                        }
                    </Table.Tbody>
