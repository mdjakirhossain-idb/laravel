...
<head>
  ...
  <link href="<?php echo e(asset('admins/img/logo/logo.png')); ?>" rel="icon">
  <title>Pos - Dashboard</title>
  <link href="<?php echo e(asset('admins/vendor/fontawesome-free/css/all.min.css')); ?>" rel="stylesheet" type="text/css">
  <link href="<?php echo e(asset('admins/vendor/bootstrap/css/bootstrap.min.css')); ?>" rel="stylesheet" type="text/css">
  <link href="<?php echo e(asset('admins/css/ruang-admin.min.css')); ?>" rel="stylesheet">
...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav sidebar sidebar-light accordion" id="accordionSidebar">
          <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
            ...
            <div class="sidebar-brand-text mx-3">BD Pos</div>
          </a>
          ...
          <li class="nav-item">
            <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#subpliers"
              aria-expanded="true" aria-controls="collapseBootstrap">
              <i class="far fa-fw fa-window-maximize"></i>
              <span>Suppliers</span>
            </a>
            <div id="subpliers" class="collapse" aria-labelledby="headingBootstrap" data-parent="#accordionSidebar">
              <div class="bg-white py-2 collapse-inner rounded">
  ...
  <script src="<?php echo e(asset('admins/js/ruang-admin.min.js')); ?>"></script>
  <script src="<?php echo e(asset('admins/vendor/chart.js/Chart.min.js')); ?>"></script>
  <script src="<?php echo e(asset('admins/js/demo/chart-area-demo.js')); ?>"></script>  
</body>

</html><?php /**PATH D:\xampp\htdocs\vue\laravel10_vuejs3_pos\resources\views/welcome.blade.php ENDPATH**/ ?>