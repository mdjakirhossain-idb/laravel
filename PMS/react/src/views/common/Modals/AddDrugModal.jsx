...
import { addDrug } from "../../../services/drug";
class AddDrugModal extends Form {
    state = {
        show: false,
    ...
    doSubmit = async () => {
        try {
            const response = await addDrug(this.state.data);
                            ...
                            <div className="relative w-auto my-6 mx-auto max-w-sm">
                                ...
                                <div className="dark:bg-secondary-dark-bg border-0 rounded-lg shadow-lg relative flex flex-col w-96 bg-white outline-none focus:outline-none">
                                    ...
                                    <form onSubmit={this.handleSubmit}>
                                        <div className="dark:bg-secondary-dark-bg block  rounded-lg bg-white p-5">
                                            {this.renderInput({
                                                label: t("drug.name"),
                                                name: "name",
                                            })}
...
export default withTranslation()(AddDrugModal);
