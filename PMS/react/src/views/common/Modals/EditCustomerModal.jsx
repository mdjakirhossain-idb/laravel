...
class EditCustomerModal extends Form {
    state = {
        show: false,
    ...
    doSubmit = async () => {
        try {
            const response = await editCustomer(this.state.data);
            ...
            <>
                ...
                {this.state.show ? (
                    <>
                        <div
                            style={{ zIndex: "400" }}
                            className="justify-center items-center flex overflow-x-hidden overflow-y-auto fixed inset-0 z-400 outline-none "
                        >
