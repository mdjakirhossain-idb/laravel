...
return [
    ...
    */
    ...
    'exists' => 'الحقل :attribute غير متاح',
    ...
    /* invoice */
    'stock_exp' => 'الحقل #:position الدواء غير متوفر بفترة انتهاء الصلاحية :value',
    'stock_qty' => 'الحقل #:position الدواء المطلوب غير متوفر بهذه الكمية :value في المستودع',
    'stock_cost' => 'الحقل #:position الدواء المطلوب غير متوفر بسعر الشراء :value في المستودع',
    /*
    |--------------------------------------------------------------------------
    ...
    */
    ...
    /*   'custom' => [
        'items.*.drug' => [
            'required' => '#:position الحقل مطلوب',
            'exists' => '#:position الحقل الدواء غير متاح',
        ],
        'items.*.qty' => [
            'required' => '#:position الحقل مطلوب',
            'min' => '#:position الحقل الكمية لا يقبل قيمة أقل من 1',
        ],
        'items.*.cost' => [
            'required' => '#:position الحقل مطلوب',
        ],
        ...
        'items.*.discount' => [
            'required' => '#:position الحقل مطلوب',
            'min' => '#:position الحقل الكمية لا يقبل قيمة أقل من 0',
        ],
    ], */
    ...
    */
    ...
    'attributes' => [
        ...
        'totalDiscount' => 'قيمة التخفيض الإجمالية',
        'Paid' => 'المدفوع',
        'drug' => 'الدواء',
        'generic' => 'الاسم العام',
        'description' => 'الوصف',
        ...
        'items.*.drug' => '#:position الدواء',
        'items.*.qty' => '#:position الكمية',
        'items.*.exp' => '#:position تاريخ انتهاء الصلاحية',
        'items.*.mfd' => '#:position تاريخ التصنيع',
        'items.*.cost' => '#:position الكلفة',
        'items.*.price' => '#:position السعر',
        'items.*.discount' => '#:position الخصم',
