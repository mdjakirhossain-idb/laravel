    ...
    <div style="margin: 40px 0;">
        ...
        <div style="margin: 20px 0;">
            ...
            <div style="border: 1px solid rgba(0,0,0,.1); padding: 10px; margin-top: 10px;">
                ...
                <div>[featured-properties title="Explore Good Places" limit="6"]At vero eos et accusamus et iusto odio dignissimos ducimus qui blanditiis praesentium voluptatum deleniti atque corrupti quos dolores[/featured-properties]</div>
